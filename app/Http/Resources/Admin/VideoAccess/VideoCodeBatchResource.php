 ...
 */
class VideoCodeBatchResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'remaining_redemptions' => $this->sold_limit !== null
                ...
                : null,
            'invoice_amount_codes' => $this->sold_limit,
    ...
    private function calculateRedemptionRate(): float
    {
        $denominator = $this->sold_limit ?? $this->quantity;
        if ($denominator <= 0) {
            return 0.0;
        }

        return round(($this->redeemed_count / $denominator) * 100, 2);
    }
